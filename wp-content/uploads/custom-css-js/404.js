...
pages.forEach((page) => {
	if (document.body.classList.contains(page)) {
		...
		// const imgHtml = `<img width="214" height="64" src="https://antoniompdev.github.io/ingenieros/wp-content/uploads/2024/12/LOGO-HUB-Ingenieros_color-positivo-fondo-blanco-1-e1733860237474.png" class="custom-logo" alt="The Hub Office" decoding="async">`
